...
themeColors[] =
{
    ...
    {//Civic
        {{QColor(255, 255, 255), QObject::tr("White")},       {QColor(0, 0, 0),       QObject::tr("Black")},
         ...
         {QColor(140, 173, 174), QObject::tr("")},            {QColor(140, 123, 112), QObject::tr("")},          {QColor(143, 176, 140), QObject::tr("")}, {QColor(209, 144, 73)}}
    },

    {//Concourse
        {{QColor(255, 255, 255), QObject::tr("White")},       {QColor(0, 0, 0),       QObject::tr("Black")},
         {QColor(222, 245, 250), QObject::tr("")},            {QColor(70, 70, 70),    QObject::tr("")},          {QColor(045, 162, 191), QObject::tr("")}, {QColor(218, 31, 40), QObject::tr("")},
         {QColor(235, 100, 27),  QObject::tr("")},            {QColor(57, 99, 157),   QObject::tr("")},          {QColor(71, 75, 120),   QObject::tr("")}, {QColor(125, 60, 74)}}
    },

    {//Currency
        {{QColor(255, 255, 255), QObject::tr("White")},       {QColor(0, 0, 0),       QObject::tr("Black")},
         {QColor(209, 225, 227), QObject::tr("")},            {QColor(74, 96, 110),   QObject::tr("")},          {QColor(121, 181, 176), QObject::tr("")}, {QColor(180, 188, 76), QObject::tr("")},
         {QColor(183, 120, 81),  QObject::tr("")},            {QColor(119, 106, 91),  QObject::tr("")},          {QColor(182, 173, 118), QObject::tr("")}, {QColor(149, 174, 177)}}
    },

    {//Deluxe
        {{QColor(255, 255, 255), QObject::tr("White")},       {QColor(0, 0, 0),       QObject::tr("Black")},
         {QColor(255, 249, 229), QObject::tr("")},            {QColor(48, 53, 110),   QObject::tr("")},          {QColor(204, 71, 87),  QObject::tr("")}, {QColor(255, 111, 97), QObject::tr("")},
         {QColor(255, 149, 62),  QObject::tr("")},            {QColor(248, 189, 82),  QObject::tr("")},          {QColor(70, 166, 189), QObject::tr("")}, {QColor(84, 136, 188)}}
    }
};
...
{
    items->addItem(new GalleryItemFontColor(qRgb(0xFF, 0xFF, 0x00), getNameColor(clr_yellow)));
    items->addItem(new GalleryItemFontColor(qRgb(0x00, 0xFF, 0x00), getNameColor(clr_bright_green)));
    items->addItem(new GalleryItemFontColor(qRgb(0x00, 0xFF, 0xFF), getNameColor(clr_turquoise)));
    items->addItem(new GalleryItemFontColor(qRgb(0xFF, 0x00, 0xFF), getNameColor(clr_pink)));
    items->addItem(new GalleryItemFontColor(qRgb(0x00, 0x00, 0xFF), getNameColor(clr_blue)));
    items->addItem(new GalleryItemFontColor(qRgb(0xFF, 0x00, 0x00), getNameColor(clr_red)));
    items->addItem(new GalleryItemFontColor(qRgb(0x00, 0x00, 0x80), getNameColor(clr_dark_blue)));
    items->addItem(new GalleryItemFontColor(qRgb(0x00, 0x80, 0x80), getNameColor(clr_teal)));
    items->addItem(new GalleryItemFontColor(qRgb(0x00, 0x80, 0x00), getNameColor(clr_green)));
    items->addItem(new GalleryItemFontColor(qRgb(0x80, 0x00, 0x80), getNameColor(clr_violet)));
    items->addItem(new GalleryItemFontColor(qRgb(0x80, 0x00, 0x00), getNameColor(clr_dark_red)));
    items->addItem(new GalleryItemFontColor(qRgb(0x80, 0x80, 0x00), getNameColor(clr_dark_yellow)));
    items->addItem(new GalleryItemFontColor(qRgb(0x80, 0x80, 0x80), getNameColor(clr_gray50)));
    items->addItem(new GalleryItemFontColor(qRgb(0xC0, 0xC0, 0xC0), getNameColor(clr_gray25)));
    items->addItem(new GalleryItemFontColor(qRgb(0x00, 0x00, 0x00), getNameColor(clr_black)));
}

void GalleryItemFontColor::addStandardColors(Qtitan::RibbonGalleryGroup* items)
{
    items->addItem(new GalleryItemFontColor(QColor(192, 0,   0),   QObject::tr("Dark Red")));
    items->addItem(new GalleryItemFontColor(QColor(255, 0,   0),   QObject::tr("Red")));
    items->addItem(new GalleryItemFontColor(QColor(255, 192, 0),   QObject::tr("Orange")));
    items->addItem(new GalleryItemFontColor(QColor(255, 255, 0),   QObject::tr("Yellow")));
    items->addItem(new GalleryItemFontColor(QColor(146, 208, 80),  QObject::tr("Light Green")));
    items->addItem(new GalleryItemFontColor(QColor(0,   176, 80),  QObject::tr("Green")));
    items->addItem(new GalleryItemFontColor(QColor(0,   176, 240), QObject::tr("Light Blue")));
    items->addItem(new GalleryItemFontColor(QColor(0,   112, 192), QObject::tr("Blue")));
    items->addItem(new GalleryItemFontColor(QColor(0,   32,  96),  QObject::tr("Dark Blue")));
    items->addItem(new GalleryItemFontColor(QColor(112, 48,  160), QObject::tr("Purple")));
}
...
void GalleryItemFontColor::addThemeColors(RibbonGalleryGroup* pItems, int nTheme)
{
    ...
    for (int j = 0; j < 6; j++)
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            ...
            pItems->addItem(new GalleryItemFontColor(clr, strToolTip, bTopMargin, bBottomMargin));
        }
    }
}
