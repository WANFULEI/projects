...
SketchChild* MainWindow::createSketchChild()
{
    ...
    QMdiSubWindow* pSubChild = m_mdiArea->addSubWindow(pChild);
    Q_ASSERT(pSubChild != Q_NULL);
    return pChild;
}
...
{
    QAction* pActionAbout = ribbonBar()->addAction(QIcon(":/shared/res/about.png"), "About", Qt::ToolButtonIconOnly);
    ...
    pActionBlue->setChecked(styleId == Qtitan::RibbonStyle::OS_OFFICE2007BLUE);
    pActionBlue->setObjectName("OS_OFFICE2007BLUE");

    QAction* pActionBlack = pMenuStyle->addAction(tr("Office 2007 Black"));
    pActionBlack->setObjectName("OS_OFFICE2007BLACK");
    pActionBlack->setCheckable(true);
    pActionBlack->setChecked(styleId == Qtitan::RibbonStyle::OS_OFFICE2007BLACK);

    QAction* pActionSilver = pMenuStyle->addAction(tr("Office 2007 Silver"));
    pActionSilver->setObjectName("OS_OFFICE2007SILVER");
    pActionSilver->setCheckable(true);
    pActionSilver->setChecked(styleId == Qtitan::RibbonStyle::OS_OFFICE2007SILVER);

    QAction* pActionAqua = pMenuStyle->addAction(tr("Office 2007 Aqua"));
    pActionAqua->setObjectName("OS_OFFICE2007AQUA");
    pActionAqua->setCheckable(true);
    pActionAqua->setChecked(styleId == Qtitan::RibbonStyle::OS_OFFICE2007AQUA);

    QAction* pActionScenic = pMenuStyle->addAction(tr("Windows 7 Scenic"));
    pActionScenic->setObjectName("OS_WINDOWS7SCENIC");
    pActionScenic->setCheckable(true);
    pActionScenic->setChecked(styleId == Qtitan::RibbonStyle::OS_WINDOWS7SCENIC);

    QAction* pAction2010Blue = pMenuStyle->addAction(tr("Office 2010 Blue"));
    pAction2010Blue->setObjectName("OS_OFFICE2010BLUE");
    pAction2010Blue->setCheckable(true);
    pAction2010Blue->setChecked(styleId == Qtitan::RibbonStyle::OS_OFFICE2010BLUE);

    QAction* pAction2010Silver = pMenuStyle->addAction(tr("Office 2010 Silver"));
    pAction2010Silver->setObjectName("OS_OFFICE2010SILVER");
    pAction2010Silver->setCheckable(true);
    pAction2010Silver->setChecked(styleId == Qtitan::RibbonStyle::OS_OFFICE2010SILVER);

    QAction* pAction2010Black = pMenuStyle->addAction(tr("Office 2010 Black"));
    pAction2010Black->setObjectName("OS_OFFICE2010BLACK");
    pAction2010Black->setCheckable(true);
    pAction2010Black->setChecked(styleId == Qtitan::RibbonStyle::OS_OFFICE2010BLACK);
