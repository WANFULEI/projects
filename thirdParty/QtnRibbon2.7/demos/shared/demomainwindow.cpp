...
void DemoMainWindow::setDemoWidget(QWidget* widget, QWidget* settings)
{
    m_demoWidget = widget;
    m_settings = settings;
    ...
    if (m_settings != 0)
        hl->addWidget(m_settings, 0, Qt::AlignTop);
    hl->setContentsMargins(20, 30, 20, 20);
    vl->addSpacing(5);
...
void DemoMainWindow::paintEvent(QPaintEvent* /*event*/)
{
    ...
    r.setHeight(70);
    painter.fillRect(r, QColor(0xFF404040));
    ...
    painter.drawText(20, 40, m_productName + " " + m_version);
