...
namespace Qtitan
{
    ...
    public:
        OfficeStyle::OptionsStyle  styleType_;
        QHash<const QWidget*, QBrush> customBrushWidgets_; // widgets whose brush we tampered
    };
}
...
{
#ifdef Q_OS_LINUX
    styleType_ = OfficeStyle::OS_OFFICE2007BLACK;
#endif /* Q_OS_LINUX */

#ifdef Q_OS_MAC
    styleType_ = OfficeStyle::OS_WINDOWS7SCENIC;
#endif /* Q_OS_MAC*/

#ifdef Q_OS_WIN
    styleType_ = OfficeStyle::OS_OFFICE2007BLUE;
#endif /* Q_OS_WIN*/
}
...
void OfficeStylePrivate::setBrush(QWidget* widget)
{
    ...
    {
        customBrushWidgets_.insert(widget, mdiArea->background());
    }
}

void OfficeStylePrivate::unsetBrush(QWidget* widget)
{
    if (customBrushWidgets_.contains(widget)) 
    {
        if (QMdiArea* mdiArea = qobject_cast<QMdiArea*>(widget))
        {
            QBrush b = customBrushWidgets_.value(widget);
            mdiArea->setBackground(b);
        }
        customBrushWidgets_.remove(widget);
    }
}
...
void OfficeStylePrivate::updateColors()
{
    ...
    helper.openIniFile(p.getStyle(QObject::tr("OfficeTheme.ini")));

    // [Window]
    p.m_clrFrame                    = helper.getColor(QObject::tr("DockingPane"), QObject::tr("WordSplitter"));

    p.m_clr3DFace                   = helper.getColor(QObject::tr("Window"), QObject::tr("ButtonFace"));  
    p.m_clrFrameBorderActive0       = helper.getColor(QObject::tr("Window"), QObject::tr("BorderActive0"));
    p.m_clrFrameBorderActive1       = helper.getColor(QObject::tr("Window"), QObject::tr("BorderActive1"));
    p.m_clrFrameBorderActive2       = helper.getColor(QObject::tr("Window"), QObject::tr("BorderActive2"));
    p.m_clrFrameBorderActive3       = helper.getColor(QObject::tr("Window"), QObject::tr("BorderActive3"));

    p.m_clrFrameBorderInactive0     = helper.getColor(QObject::tr("Window"), QObject::tr("BorderInactive0"));
    p.m_clrFrameBorderInactive1     = helper.getColor(QObject::tr("Window"), QObject::tr("BorderInactive1"));
    p.m_clrFrameBorderInactive2     = helper.getColor(QObject::tr("Window"), QObject::tr("BorderInactive2"));
    p.m_clrFrameBorderInactive3     = helper.getColor(QObject::tr("Window"), QObject::tr("BorderInactive3"));

    p.m_clrHighlightBorder          = helper.getColor(QObject::tr("Window"), QObject::tr("HighlightSelectedBorder"));
    p.m_clrHighlightPushedBorder    = helper.getColor(QObject::tr("Window"), QObject::tr("HighlightPressedBorder"));
    p.m_clrHighlightCheckedBorder   = helper.getColor(QObject::tr("Window"), QObject::tr("HighlightCheckedBorder"));
    p.m_clrHighlightPushed          = helper.getColor(QObject::tr("Window"), QObject::tr("HighlightPressed"));
    p.m_clrHighlight                = helper.getColor(QObject::tr("Window"), QObject::tr("HighlightSelected"));
    p.m_clrHighlightChecked         = helper.getColor(QObject::tr("Window"), QObject::tr("HighlightChecked"));

    p.m_palLunaSelected.setColor(QPalette::Dark, helper.getColor(QObject::tr("Window"), QObject::tr("HighlightSelectedDark")));
    p.m_palLunaSelected.setColor(QPalette::Light, helper.getColor(QObject::tr("Window"), QObject::tr("HighlightSelectedLight")));

    p.m_palLunaPushed.setColor(QPalette::Dark, helper.getColor(QObject::tr("Window"), QObject::tr("HighlightPressedDark")));
    p.m_palLunaPushed.setColor(QPalette::Light, helper.getColor(QObject::tr("Window"), QObject::tr("HighlightPressedLight")));

    p.m_palLunaChecked.setColor(QPalette::Dark, helper.getColor(QObject::tr("Window"), QObject::tr("HighlightCheckedDark")));
    p.m_palLunaChecked.setColor(QPalette::Light, helper.getColor(QObject::tr("Window"), QObject::tr("HighlightCheckedLight")));

    p.m_clrFrameCaptionTextInActive = helper.getColor(QObject::tr("Window"), QObject::tr("CaptionTextInActive"));
    p.m_clrFrameCaptionTextActive   = helper.getColor(QObject::tr("Window"), QObject::tr("CaptionTextActive"));

    p.m_clrTooltipLight             = helper.getColor(QObject::tr("Window"), QObject::tr("TooltipLight"));
    p.m_clrTooltipDark              = helper.getColor(QObject::tr("Window"), QObject::tr("TooltipDark"));
    p.m_clrTooltipBorder            = helper.getColor(QObject::tr("Window"), QObject::tr("TooltipBorder"));

    // [Workspace]
    p.m_clrAppWorkspace             = helper.getColor(QObject::tr("Workspace"), QObject::tr("AppWorkspace"));
    p.m_clrWorkspaceClientTop       = helper.getColor(QObject::tr("Workspace"), QObject::tr("WorkspaceClientTop"));
    p.m_clrWorkspaceClientMiddle    = helper.getColor(QObject::tr("Workspace"), QObject::tr("WorkspaceClientMiddle"));
    p.m_clrWorkspaceClientBottom    =  helper.getColor(QObject::tr("Workspace"), QObject::tr("WorkspaceClientBottom"));

    // [Ribbon]
    p.m_clrControlEditNormal        = helper.getColor(QObject::tr("Ribbon"), QObject::tr("ControlEditNormal"));
    p.m_clrMenuPopupText            = helper.getColor(QObject::tr("Ribbon"), QObject::tr("MenuPopupText"));
    p.m_clrTabNormalText            = helper.getColor(QObject::tr("Ribbon"), QObject::tr("TabNormalText"));
    p.m_clrHighlightText            = helper.getColor(QObject::tr("Ribbon"), QObject::tr("RibbonText"));
    p.m_clrSelectedText             = helper.getColor(QObject::tr("Ribbon"), QObject::tr("TabSelectedText"));
    p.m_clrToolBarText              = helper.getColor(QObject::tr("Ribbon"), QObject::tr(/*"RibbonText"*/"MenuPopupText"));
    p.m_clrMenuPopupGripperShadow   = helper.getColor(QObject::tr("Ribbon"), QObject::tr("MenuPopupGripperShadow"), QColor(197, 197, 197));
    p.m_clrMenuGripper              = helper.getColor(QObject::tr("Ribbon"), QObject::tr("MenuPopupGripper"));

    // [Toolbar]
    p.m_clrEditCtrlBorder           = helper.getColor(QObject::tr("Toolbar"), QObject::tr("ControlEditBorder"));
    p.m_clrMenuBarText              = helper.getColor(QObject::tr("Toolbar"), QObject::tr("MenuBarText"));
    p.m_ToolbarGripper              = helper.getColor(QObject::tr("Toolbar"), QObject::tr("ToolbarGripper"));
    p.m_clrControlGallerySelected   = helper.getColor(QObject::tr("Toolbar"), QObject::tr("ControlGallerySelected"));
    p.m_clrControlGalleryNormal     = helper.getColor(QObject::tr("Toolbar"), QObject::tr("ControlGalleryNormal"));
    p.m_clrControlGalleryBorder     = helper.getColor(QObject::tr("Toolbar"), QObject::tr("ControlGalleryBorder"));
    p.m_clrControlGalleryLabel      = helper.getColor(QObject::tr("Toolbar"), QObject::tr("ControlLabel"));
    p.m_clrDockBar                  = helper.getColor(QObject::tr("Toolbar"), QObject::tr("DockBarFace"));
    p.m_clrMenubarBorder            = helper.getColor(QObject::tr("Toolbar"), QObject::tr("MenuPopupBorder"));  
    p.m_clrToolbarFace              = helper.getColor(QObject::tr("Toolbar"), QObject::tr("ToolbarFace"));
    p.m_clrToolbarSeparator         = helper.getColor(QObject::tr("Toolbar"), QObject::tr("ToolbarSeparator"));

    // [PopupControl]
    p.m_clrBackgroundLight = helper.getColor(QObject::tr("PopupControl"), QObject::tr("BackgroundLight"));
    p.m_clrBackgroundDark  = helper.getColor(QObject::tr("PopupControl"), QObject::tr("BackgroundDark"));
    p.m_clrCaptionLight = helper.getColor(QObject::tr("PopupControl"), QObject::tr("CaptionLight"));
    p.m_clrCaptionDark  = helper.getColor(QObject::tr("PopupControl"), QObject::tr("CaptionDark"));


    // [ShortcutBar]
    p.m_clrShortcutItemShadow = helper.getColor(QObject::tr("ShortcutBar"), QObject::tr("FrameBorder"));

    p.m_clrCommandBar.setColor(QPalette::Dark, helper.getColor(QObject::tr("Toolbar"), QObject::tr("ToolbarFaceDark")));
    p.m_clrCommandBar.setColor(QPalette::Light, helper.getColor(QObject::tr("Toolbar"), QObject::tr("ToolbarFaceLight")));
    p.m_clrCommandBar.setColor(QPalette::Shadow, helper.getColor(QObject::tr("Toolbar"), QObject::tr("ToolbarFaceShadow")));

    p.m_clrPopupControl.setColor(QPalette::Dark, helper.getColor(QObject::tr("Toolbar"), QObject::tr("ControlHighlightPopupedDark")));
    p.m_clrPopupControl.setColor(QPalette::Light, helper.getColor(QObject::tr("Toolbar"), QObject::tr("ControlHighlightPopupedLight")));

    // [DockingPane]
    p.m_palNormalCaption.setColor(QPalette::Dark, helper.getColor(QObject::tr("DockingPane"), QObject::tr("NormalCaptionDark")));
    p.m_palNormalCaption.setColor(QPalette::Light, helper.getColor(QObject::tr("DockingPane"), QObject::tr("NormalCaptionLight")));
    p.m_clrNormalCaptionText = helper.getColor(QObject::tr("DockingPane"), QObject::tr("NormalCaptionText"));

    p.m_palActiveCaption.setColor(QPalette::Dark, helper.getColor(QObject::tr("DockingPane"), QObject::tr("ActiveCaptionDark")));
    p.m_palActiveCaption.setColor(QPalette::Light, helper.getColor(QObject::tr("DockingPane"), QObject::tr("ActiveCaptionLight")));
    p.m_clrActiveCaptionText = helper.getColor(QObject::tr("DockingPane"), QObject::tr("ActiveCaptionText"));

    p.m_palSplitter.setColor(QPalette::Dark, helper.getColor(QObject::tr("DockingPane"), QObject::tr("SplitterDark")));
    p.m_palSplitter.setColor(QPalette::Light, helper.getColor(QObject::tr("DockingPane"), QObject::tr("SplitterLight")));

    // [StatusBar]
    p.m_clrStatusBarText = helper.getColor(QObject::tr("StatusBar"), QObject::tr("StatusBarText"));
    p.m_clrStatusBarShadow = helper.getColor(QObject::tr("StatusBar"), QObject::tr("StatusBarShadow"));
    p.m_palStatusBarTop.setColor(QPalette::Dark, helper.getColor(QObject::tr("StatusBar"), QObject::tr("StatusBarFaceTopDark")));
    p.m_palStatusBarTop.setColor(QPalette::Light, helper.getColor(QObject::tr("StatusBar"), QObject::tr("StatusBarFaceTopLight")));
    p.m_palStatusBarBottom.setColor(QPalette::Dark, helper.getColor(QObject::tr("StatusBar"), QObject::tr("StatusBarFaceBottomDark")));
    p.m_palStatusBarBottom.setColor(QPalette::Light, helper.getColor(QObject::tr("StatusBar"), QObject::tr("StatusBarFaceBottomLight")));

    // [Controls]
    p.m_crBorderShadow = helper.getColor(QObject::tr("Controls"), QObject::tr("GroupBoxFrame"));
    p.m_tickSlider = helper.getColor(QObject::tr("Controls"), QObject::tr("TickSlider"));  

    // [ReportControl]
    p.m_palGradientColumn.setColor(QPalette::Dark, helper.getColor(QObject::tr("ReportControl"), QObject::tr("NormalColumnDark")));
    p.m_palGradientColumn.setColor(QPalette::Light, helper.getColor(QObject::tr("ReportControl"), QObject::tr("NormalColumnLight")));
    p.m_palGradientColumn.setColor(QPalette::Shadow, helper.getColor(QObject::tr("ReportControl"), QObject::tr("ColumnShadow")));

    p.m_palGradientColumnPushed.setColor(QPalette::Dark, helper.getColor(QObject::tr("ReportControl"), QObject::tr("PressedColumnDark")));
    p.m_palGradientColumnPushed.setColor(QPalette::Light, helper.getColor(QObject::tr("ReportControl"), QObject::tr("PressedColumnLight")));

    p.m_clrColumnSeparator = helper.getColor(QObject::tr("ReportControl"), QObject::tr("ColumnSeparator"));
    p.m_clrGridLineColor = helper.getColor(QObject::tr("PropertyGrid"), QObject::tr("GridLine"));
}
...
void OfficeStyle::setOptionStyle(OptionsStyle style)
{
    QTN_D(OfficeStyle);
    if (d.styleType_ != style) 
    {
        d.styleType_ = style;
        clearCache();

        QWidgetList all = getAllWidgets();
...
//        palette.setColor(QPalette::Background, Qt::transparent);
    ...
    else if (!ignoreDialogs() && qobject_cast<QDialog*>(widget))
    {
        QPalette palette = widget->palette();
...
//        palette.setBrush(QPalette::WindowText, QColor(255, 0,0));
        widget->setPalette(palette);
    }
    ...
    else if (qobject_cast<QTabBar*>(widget) && qobject_cast<QMdiArea*>(widget->parentWidget()))
    {
        widget->setAutoFillBackground(true);
        QPalette palette = widget->palette();
//        palette.setColor(QPalette::Background, helper().getColor(tr("Ribbon"), tr("RibbonFace")));
...
{
    QTN_D(const OfficeStyle);
    return d.styleType_ == OS_OFFICE2010BLACK || d.styleType_ == OS_OFFICE2010BLUE || d.styleType_ == OS_OFFICE2010SILVER;
}
        ...
        else 
        {
            ...
            if (toolbutton->toolButtonStyle != Qt::ToolButtonIconOnly)
            {
                ...
                if (toolbutton->toolButtonStyle == Qt::ToolButtonTextUnderIcon)
                {
                    ...
                    QRect rcFirstRowText(QPoint(rcText.left(), rcText.top()-1), QPoint(rcText.right(), rcText.center().y() + 1));
                    ...
                    if (!strSecondRow.isEmpty()) 
                    {
                        ...
                        QRect rcSecondRowText(QPoint(left, rcFirstRowText.bottom()+1), QPoint(rcText.right(), rcText.bottom()+2));
...
/*
            ...
            else if (popuped) nState = 2;
            else if (checked && !selected && !pressed) nState = 2;
            else if (checked && selected && !pressed) nState = 3;
            else if (selected && pressed) nState = 1;
            else if (selected || pressed) nState = 0;

            QPixmap soButton = smallSize ? cached("ToolbarButtons22.png") 
                : cached("ToolbarButtons50.png");
            drawImage(soButton, *p, opt->rect, getSource(soButton.rect(), nState, 4), QRect(QPoint(8, 8), QPoint(8, 8)));
*/
            return true;
        }
...
bool OfficeStyle::drawIndicatorToolBarSeparator(const QStyleOption* opt, QPainter* p, const QWidget* w) const 
{
    ...
    QWindowsStyle::drawPrimitive(QStyle::PE_IndicatorToolBarSeparator, &option, p, w);
    return true; 
}
...
QRect getSourceH(QRect rcSrc, int nState, int nCount)
{
        ...
        if ((opt->subControls & SC_SliderHandle)) 
        {
            ...
            if (slider->orientation == Qt::Horizontal)
            {
                ...
                else
                {
                    ...
                    rcSrc = getOptionStyle() == OS_OFFICE2010SILVER || getOptionStyle() == OS_OFFICE2007AQUA ? getSource(hndl.rect(), stateId, 5) : getSourceH(hndl.rect(), stateId, 5);
                }
            }
...
bool OfficeStyle::drawScrollBar(const QStyleOptionComplex* opt, QPainter* p, const QWidget* w) const
{
    if (const QStyleOptionSlider* scrollbar = qstyleoption_cast<const QStyleOptionSlider*>(opt))
    {
        ...
        bool light = w && (qobject_cast<const RibbonGallery*>(w->parentWidget()) ||
                            qobject_cast<const QDialog*>(w->topLevelWidget()));
...
bool OfficeStyle::drawScrollBarLine(ControlElement element, const QStyleOption* opt, QPainter* p, const QWidget* w) const
{
    ...
    if (const QStyleOptionSlider* scrollbar = qstyleoption_cast<const QStyleOptionSlider*>(opt))
    {
        bool light = !(opt->state & State_Sunken);
        QPixmap soImage;
        ...
        QPixmap soImageArrowGlyphs = cached("ControlGalleryScrollArrowGlyphs.png");
        int number = -1;
        if (opt->state & State_Horizontal) 
        {
            QRect rcSrc;
...
bool OfficeStyle::drawScrollBarSlider(const QStyleOption* opt, QPainter* p, const QWidget* w) const
{
    ...
    if (const QStyleOptionSlider* scrollbar = qstyleoption_cast<const QStyleOptionSlider*>(opt)) 
    {
        if (!opt->rect.isEmpty())
        {
            ...
            QRect rc(opt->rect);
            QPixmap pImage = opt->state & State_Horizontal ? cached("ControlGalleryScrollThumbHorizontal.png")
                                                           : cached("ControlGalleryScrollThumbVertical.png");
            Q_ASSERT(pImage);
            bool show = opt->state & State_Horizontal ? rc.width() > 7 : rc.height() > 7;
            if( !rc.isEmpty() && show )
                drawImage(pImage, *p, rc, getSource(pImage.rect(), state, 3), QRect(QPoint(5, 5), QPoint(5, 5)));
...
bool OfficeStyle::drawScrollBarPage(ControlElement element, const QStyleOption* opt, QPainter* p, const QWidget* w) const
{
    ...
    if (opt->state & State_Horizontal) 
    {
        QPixmap soImage = cached("ControlGalleryScrollHorizontalDark.png"); 
        if (!soImage.isNull())
            drawImage(soImage, *p, opt->rect, getSource(soImage.rect(), 1, 2), QRect(QPoint(0, 1), QPoint(0, 1)));
    }
    else
    {
        QPixmap soImage = cached("ControlGalleryScrollVerticalDark.png"); 
        if (!soImage.isNull())
...
bool OfficeStyle::drawItemViewItem(const QStyleOption* opt, QPainter* p, const QWidget* widget) const
{
    if (const QStyleOptionViewItemV4* vopt = qstyleoption_cast<const QStyleOptionViewItemV4*>(opt)) 
    {
        ...
        QWindowsStyle::drawControl(CE_ItemViewItem, &adjustedOption, p, widget);
        return true;
    }
...
bool OfficeStyle::drawPanelItemViewItem(const QStyleOption* opt, QPainter* p, const QWidget* widget) const
{
    if (const QStyleOptionViewItemV4* vopt = qstyleoption_cast<const QStyleOptionViewItemV4*>(opt))
    {
        if (qobject_cast<const QTableView*>(widget))
        {
            ...
            QColor clrSelectionBackground = helper().getColor(tr("ReportControl"), tr("SelectionBackground"));
            palette.setColor(cg, QPalette::Highlight, clrSelectionBackground);

            QStyleOptionViewItemV4 adjustedOption = *vopt;
            adjustedOption.palette = palette;

            QWindowsStyle::drawPrimitive(PE_PanelItemViewItem, &adjustedOption, p, widget);
            return true;
        }
        ...
        case PE_IndicatorArrowLeft:
            {
                ...
                else if (pe == PE_IndicatorArrowDown)
                {
                    ...
                    {
                        if (/*but->menu() &&*/ qobject_cast<QToolBar*>(w->parentWidget()) &&  !qobject_cast<const QTabBar*>(w->parentWidget()))
                        {
